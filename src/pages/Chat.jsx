...
export default function Chat() {
  ...
  return (
    <div style={styles.page}>
      ...
      {/* Chat Area */}
      <div id="main-content" style={styles.chatArea} role="main" aria-label="Chat conversation">
        {/* Disclaimer Banner */}
        <div style={disclaimerStyle}>
          <svg style={{ display: 'inline', width: '14px', height: '14px', marginRight: '6px', verticalAlign: 'middle', color: '#7b1c2e' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>
          This AI assistant provides general educational information about federal retirement benefits. Responses are generated by artificial intelligence and may contain errors or outdated information. This is not financial, legal, or tax advice. Always verify information with OPM.gov or a qualified advisor.
        </div>
            ...
            >
              {msg.role === 'assistant' && (
                <div style={styles.avatar}>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#0f172a" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><rect x="7" y="7" width="3" height="3"></rect><rect x="14" y="7" width="3" height="3"></rect><path d="M9 15h6"></path><path d="M8 11h8"></path></svg>
                </div>
              )}
              <div
                style={{
...
function TypingIndicator() {
  return (
    <div style={{ display: 'flex', gap: 4, alignItems: 'center', padding: '4px 0' }} aria-label="AI is typing">
      {[0, 1, 2].map(i => (
        <div
          key={i}
          style={{
